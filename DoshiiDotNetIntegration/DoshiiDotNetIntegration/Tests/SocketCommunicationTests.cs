...
namespace DoshiiDotNetIntegration.Tests
{
    ...
    public class SocketCommunicationTests
    {
        ...
        CommunicationLogic.DoshiiWebSocketsCommunication SocketComs;
        CommunicationLogic.DoshiiWebSocketsCommunication MockSocketComs;
        ...
        public void Init()
        {
            ...
            MockSocketComs = MockRepository.GeneratePartialMock<CommunicationLogic.DoshiiWebSocketsCommunication>(GenerateObjectsAndStringHelper.TestSocketUrl, OperationLogic, GenerateObjectsAndStringHelper.TestTimeOutValue);
            SocketComs = new CommunicationLogic.DoshiiWebSocketsCommunication(GenerateObjectsAndStringHelper.TestSocketUrl, OperationLogic, GenerateObjectsAndStringHelper.TestTimeOutValue);
        ...
        {
            var socketComs = new CommunicationLogic.DoshiiWebSocketsCommunication("", OperationLogic, GenerateObjectsAndStringHelper.TestTimeOutValue);
        }
        ...
        {
            var socketComs = new CommunicationLogic.DoshiiWebSocketsCommunication(GenerateObjectsAndStringHelper.TestSocketUrl, null, GenerateObjectsAndStringHelper.TestTimeOutValue);
        }
        ...
        {
            var socketComs = new CommunicationLogic.DoshiiWebSocketsCommunication(GenerateObjectsAndStringHelper.TestSocketUrl, null, 0);
        }

        [Test]
        public void Constructor_AllParamatersCorrect()
        {
            var socketComs = new CommunicationLogic.DoshiiWebSocketsCommunication(GenerateObjectsAndStringHelper.TestSocketUrl, OperationLogic, GenerateObjectsAndStringHelper.TestTimeOutValue);
        ...
        //{
        //    MockSocketComs.Expect(x => x.HeartBeatChecker()).Repeat.Once();
