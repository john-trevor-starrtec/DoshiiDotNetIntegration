...
namespace DoshiiDotNetIntegration.Models.Json
{
    ...
    [DataContract]
    [Serializable]
    internal class JsonProductOptions : JsonSerializationBase<JsonProductOptions>
    {
        /// <summary>
        ...
        private List<JsonVariants> _Selected;
        ...
        public List<JsonVariants> Selected
        {
            get
            {
                if (_Selected == null)
                {
                    _Selected = new List<JsonVariants>();
                }
                return _Selected;
            }
            set
