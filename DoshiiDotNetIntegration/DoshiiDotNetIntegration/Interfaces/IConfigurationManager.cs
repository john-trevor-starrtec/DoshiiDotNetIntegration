...
{
    /// <summary>
    /// Implementations of the <c>ILoggingManager</c> interface allow the pos to provide the socketUrl to the doshii SDK, if this interface is not implemented the doshii SDK will generate the socket
